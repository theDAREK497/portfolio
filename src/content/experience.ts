...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    points: {
      en: [
        'Measured page-loading performance with Chrome DevTools, Lighthouse and PageSpeed Insights. Used the findings to refactor legacy code, implement Bitrix Composite Site, optimise APIs and JavaScript, and improve caching and lazy loading.',
      ...
      ru: [
        'Измерял скорость загрузки сайта с помощью Chrome DevTools, Lighthouse и PageSpeed Insights. По результатам переработал устаревший код, внедрил «Композитный сайт» Битрикс, оптимизировал API и JavaScript, улучшил кеширование и отложенную загрузку.',
